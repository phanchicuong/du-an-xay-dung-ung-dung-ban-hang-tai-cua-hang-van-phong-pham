...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hinh/black-friday.png"))); // NOI18N
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 5, 500, 440));

        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/bg-login.png"))); // NOI18N
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 35, 500, 340));
        ...
        jPanel2.add(disable1, new org.netbeans.lib.awtextra.AbsoluteConstraints(335, 216, 40, 40));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String user = DangNhapDAO.getUsername(txtusername.getText());
        String passWord = DangNhapDAO.getPassword(txtusername.getText());
        if(user.equals(txtusername.getText())&&passWord.equals(txtpassword.getText()))
        {
            TenDangNhap = DangNhapDAO.getUsername(txtusername.getText());
            TrangChu frmTC = new TrangChu();
            frmTC.show();
            this.dispose();
        }
        else{
